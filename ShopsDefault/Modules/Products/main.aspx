<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"  CodeBehind="main.aspx.cs" Inherits="ShopsDefault.Modules.Products.main" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>Products - EZ Bikes</title>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentMain" runat="server">
    <div id="product_main_w" runat="server"></div>
</asp:Content>
