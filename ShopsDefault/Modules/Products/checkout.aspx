<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"  CodeBehind="checkout.aspx.cs" Inherits="ShopsDefault.Modules.Products.checkout" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>Thanh Toán - EZ Bikes</title>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentMain" runat="server">
    <div id="checkout_main_w" runat="server"></div>
</asp:Content>
