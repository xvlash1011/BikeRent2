<%@ Control Language="C#" AutoEventWireup="true"  CodeBehind="order-reminder.ascx.cs" Inherits="ShopsDefault.AdminTools.UserControls.Products.Products.order_reminder" %>
