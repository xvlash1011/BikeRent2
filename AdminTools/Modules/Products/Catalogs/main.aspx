<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTools/AdminTools.Master" AutoEventWireup="true"  CodeBehind="main.aspx.cs" Inherits="ShopsDefault.AdminTools.Modules.Products.Catalogs.main" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>EZ Bikes - Quản Lý Products Category</title>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentMain" runat="server">
    <div class="main">
        <div id="catalogs_ww" runat="server">
        </div>
    </div>
</asp:Content>
